...
const filteredstring = strings.filter(str => str.length >=5);
...
const concatenatedString = alphabets.reduce((accumulator, currentElement) => {
...
console.log(hasElementLessThan45);  
...
const hasbike = person.hasOwnProperty('vehicles')&&person.hasOwnProperty('bike')
